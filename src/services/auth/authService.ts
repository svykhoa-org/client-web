...
export const register = async (userData: RegisterRequest): Promise<SuccessResponse<AuthResponseData>> => {
  return await httpClient.post<AuthResponseData>('/auth/register', userData);
};

export const login = async (credentials: LoginRequest): Promise<SuccessResponse<AuthResponseData>> => {
...
export const refreshToken = async (data: RefreshTokenRequest): Promise<SuccessResponse<AuthResponseData>> => {
...
export const changePassword = async (data: ChangePasswordRequest): Promise<SuccessResponse<{ message: string }>> => {
...
export const resetPassword = async (data: ResetPasswordRequest): Promise<SuccessResponse<{ message: string }>> => {
...
export const enable2FA = async (data: TwoFAEnableRequest): Promise<SuccessResponse<{ message: string }>> => {
  return await httpClient.post<{ message: string }>('/auth/2fa/enable', data);
};

export const authenticate2FA = async (data: TwoFAAuthenticateRequest): Promise<SuccessResponse<AuthResponseData>> => {
