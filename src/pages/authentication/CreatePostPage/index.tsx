...
const CreatePostPage = () => {
  ...
  const handleSubmit = async (values: FormData) => {
    ...
    try {
      ...
      const createPostData: CreatePostData = {
        ...
        authorId: user.id, // Sử dụng user ID thực tế
      ...
      const response = await createPost({
        ...createPostData,
        id: '', // Placeholder, sẽ được server tạo
  ...
  return (
    <div className="flex justify-center p-4 md:p-8">
      <Card
        title={<h1 className="text-2xl font-bold">Tạo bài viết mới</h1>}
        className="mx-auto w-4xl max-w-4xl"
      >
        <Form
          form={form}
          layout="vertical"
        ...
        >
          ...
          >
            <Select
              ...
              notFoundContent={
                loadingCategories ? <Spin size="small" /> : 'Không tìm thấy danh mục'
              }
            >
